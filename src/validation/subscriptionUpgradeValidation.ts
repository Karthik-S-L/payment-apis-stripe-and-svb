export function upgradeSubscriptionValidation(upgradeSubscriptionDto) {
  let subscriptionId = upgradeSubscriptionDto.subscriptionId;
  ...
  } else if (!upgradeSubscriptionDto.priceCode) {
