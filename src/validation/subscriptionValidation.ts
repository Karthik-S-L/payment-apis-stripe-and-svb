export function subscriptionValidation(subscriptionDto) {
    let customerId = subscriptionDto.customerId;
    ...
    else if(!subscriptionDto.priceCode){
        return "price code is not present"
    }
  }
